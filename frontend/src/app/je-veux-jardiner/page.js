    ...
    <div className="min-h-screen p-6 bg-white">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Compétence(s) :</label>
            <input
              type="text"
              name="services"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Année(s) d&apos;expériences :</label>
            <input
              type="text"
              name="services"
              value={formData.services}
